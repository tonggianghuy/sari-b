(function ($) {
    ...
    function featuresSlider2() {
        ...
        $(".features--slider-2 .slider-contents").slick({
            ...
            //   prevArrow: '<button type="button" class="slick-prev"><i class="fa fa-caret-left icon-color-white" aria-hidden="true"></i></button>',
            //   nextArrow: '<button type="button" class="slick-next"><i class="fa fa-caret-right  icon-color-white" aria-hidden="true""></i></button>',
        });
    ...
    function mobileImage() {
        $(".people-image").slick({
            ...
            autoplay: true,
            arrows: false,
            // prevArrow: <button type="button" class="slick-prev">hhhhh</button>,
            responsive: [
                {
                    breakpoint: 1024,
                    settings: {
